...
import com.netbirdtech.android.app.jiaoyiquan.activity.EditActivity;
...
public class PhotoRVAdapter extends RecyclerView.Adapter<PhotoRVAdapter.PhotoViewHolder> {
    ...
    public PhotoRVAdapter(Context mContext, ArrayList<String> photoPaths) {
    ...
    public void onBindViewHolder(final PhotoViewHolder holder, final int position) {
        //在RecylerView的在后面增加个添加按钮
        if(photoPaths.size()==0 || position == photoPaths.size()){
            holder.ivPhoto.setBackgroundResource(R.mipmap.addimage_icon);
            holder.ivPhoto.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.setColumn(4);
                    mActivity.startActivityForResult(intent, EditActivity.REQUEST_CODE);
                }
            });
            return  ;
        }
